...
function DepthTest() {
  ...
  function resize() {
    const { renderWindow, openGLRenderWindow, textCanvas } = context.current;
    const dims = vtkContainerRef.current.getBoundingClientRect();
  ...
  useEffect(() => {
    ...
    context.current["openGLRenderWindow"] = openGLRenderWindow;

    const textCanvas = document.createElement("canvas");
    textCanvas.style.position = "absolute";
    textCanvas.style.top = "0px";
    textCanvas.style.left = "0px";
    vtkContainerRef.current.appendChild(textCanvas);

    textCtx = textCanvas.getContext("2d");
    context.current["textCanvas"] = textCanvas;
